const data=[
    {
      ...
      "about": "Occaecat nulla cupidatat sunt labore dolor occaecat proident nulla nulla commodo qui laborum reprehenderit nisi. Velit reprehenderit sint officia quis enim culpa et fugiat. Velit ullamco enim Lorem ex proident proident. Mollit deserunt dolore dolor magna duis pariatur ex deserunt mollit laboris quis irure. Reprehenderit consequat incididunt sit duis nostrud proident velit anim sit id Lorem reprehenderit aliquip.\r\n",
    ...
    },
    {
      ...
      "about": "Duis exercitation nulla commodo anim. Enim veniam laborum enim aute pariatur. Amet aute ex qui esse ipsum labore aliquip veniam. Commodo irure eiusmod aute culpa occaecat officia duis non proident elit minim mollit. Commodo nisi ea Lorem ut consectetur occaecat tempor aliquip occaecat esse.\r\n",
    ...
    },
    {
      ...
      "about": "Lorem incididunt sint consequat in laborum veniam aliqua eu laboris reprehenderit consectetur laborum ullamco est. Ad Lorem pariatur elit mollit adipisicing anim amet cillum culpa commodo sint mollit nulla. Ullamco minim quis culpa occaecat dolor mollit.\r\n",
    ...
    },
    {
      ...
      "about": "Adipisicing pariatur eu commodo veniam. Nisi incididunt ut ex dolor ipsum id. Officia enim elit aliqua occaecat. Est tempor duis qui dolor cupidatat eiusmod. Nostrud mollit non voluptate nostrud mollit aute sit enim pariatur adipisicing sit.\r\n",
    ...
    },
    {
      ...
      "about": "Sunt laborum incididunt mollit irure ad adipisicing aute. Eiusmod labore ut sit elit Lorem duis. Velit mollit ex Lorem esse cupidatat laborum ipsum pariatur. Aute velit labore dolore labore labore. Velit et esse est proident. Excepteur ad incididunt cupidatat culpa aliqua sint enim voluptate. Ipsum ea veniam qui et ex quis ullamco officia sit proident nulla adipisicing quis quis.\r\n",
    ...
    },
    {
      ...
      "about": "Cillum nulla ut esse veniam exercitation. Ea voluptate ad eiusmod ea. Nostrud do pariatur enim aliquip. Voluptate eu ut pariatur mollit dolor.\r\n",
...
//for filter by ge above 25 years
document.getElementById('age_filter').innerHTML=data.filter(data => data.age >25).map(e => "Name: "+e.name + "<br>" +"Age: "+ e.age+"<br><br>");

//filter and count by male.
document.getElementById('male_data').innerHTML = data.filter(data=>data.gender=='male').map(e=>"Name: "+e.name + "<br>" +"Age: "+ e.gender+"<br><br>");
let count_male=data.filter(data=>data.gender=='male');
document.getElementById('count_male').innerHTML = "Number of Male in List is: "+count_male.length;

//filter and count by female
document.getElementById('female_data').innerHTML = data.filter(data=>data.gender=='female').map(e=>"Name: "+e.name + "<br>" +"Age: "+ e.gender+"<br><br>");
let count_female=data.filter(data=>data.gender=='female');
document.getElementById('count_female').innerHTML = "Number of Female in List is: "+count_female.length;

// let result = data.map(
//   o => Object.assign(o, {tags: o.tags.filter(v => v === "dolor")})
// );
var result = data.reduce((a,curr) => a + (curr.balance.replace('$','') ? Number(curr.balance.replace('$','')) : 0), 0);
console.log(result);
